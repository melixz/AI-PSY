...
const InputDiary: React.FC<InputDiaryProps> = ({
  ...
  const mockResponse =
    "Спасибо за ваш дневниковый вход! Ваши чувства и мысли важны. Постарайтесь обратить внимание на повторяющиеся эмоции и ситуации, чтобы лучше понять себя. Спасибо за ваш дневниковый вход! Ваши чувства и мысли важны. Постарайтесь обратить внимание на повторяющиеся эмоции и ситуации, чтобы лучше понять себя.Спасибо за ваш дневниковый вход! Ваши чувства и мысли важны. Постарайтесь обратить внимание на повторяющиеся эмоции и ситуации, чтобы лучше понять себя.     Спасибо за ваш дневниковый вход! Ваши чувства и мысли важны. Постарайтесь обратить внимание на повторяющиеся эмоции и ситуации, чтобы лучше понять себя.     Спасибо за ваш дневниковый вход! Ваши чувства и мысли важны. Постарайтесь обратить внимание на повторяющиеся эмоции и ситуации, чтобы лучше понять себя.";
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      setIsSubmitted(true); // Меняем инпут на текстовый блок
      onSubmit(value);
    }, 1500);
  };
  ...
  return (
    <div className="w-[800px] h-auto flex flex-col space-y-10">
      ...
      {/* Обертка с фиксированной высотой, чтобы инпут не прыгал */}
      <div className="h-[40px] flex justify-center gap-4 items-center">
        <SegmentBtn
          title="Отмена"
          isActive={false}
          onClick={handleCancel}
          className={value.trim() !== "" || isRecording || isSubmitted ? "visible" : "invisible"}
        />
        {!isSubmitted && (
          <SegmentBtn
            title="Сохранить"
            isActive={true}
            onClick={handleSend}
            className={value.trim() !== "" || isRecording ? "visible" : "invisible"}
          />
        )}
      </div>
    </div>
